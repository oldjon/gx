...
var file_health_proto_rawDesc = []byte{
	...
	,
...
var file_health_proto_goTypes = []interface{}{
	(*Health)(nil),              // 0: base.Health
	(*Health_PingRequest)(nil),  // 1: base.Health.PingRequest
	(*Health_PingResponse)(nil), // 2: base.Health.PingResponse
}
var file_health_proto_depIdxs = []int32{
	1, // 0: base.HealthService.Ping:input_type -> base.Health.PingRequest
	2, // 1: base.HealthService.Ping:output_type -> base.Health.PingResponse
...
func file_health_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_health_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Health_PingRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_health_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Health_PingResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
