...
func (c *healthServiceClient) Ping(ctx context.Context, in *Health_PingRequest, opts ...grpc.CallOption) (*Health_PingResponse, error) {
	out := new(Health_PingResponse)
	err := c.cc.Invoke(ctx, "/base.HealthService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HealthServiceServer interface {
	Ping(context.Context, *Health_PingRequest) (*Health_PingResponse, error)
...
func _HealthService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/base.HealthService/Ping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).Ping(ctx, req.(*Health_PingRequest))
	}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "base.HealthService",
